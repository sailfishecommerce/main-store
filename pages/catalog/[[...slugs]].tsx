...
import { viewModeAtom } from "@/components/view-modes";
import { ProductCardHit } from "@/components/cards/ProductCardHit";
import { configAtom } from "@/components/algolia/config";
import { useIsMounted } from "@/hooks/useIsMounted";
import { useTailwindScreens } from "@/hooks/useTailwindScreens";
import type { SearchPageLayoutProps } from "@/layouts/SearchpageLayout";
import {
  getServerSidePropsPage,
  SearchPageLayout,
} from "@/layouts/SearchpageLayout";
...
export default function Catalog(props: SearchPageLayoutProps) {
  ...
  return (
    <SearchPageLayout {...props}>
      <div className="flex flex-col gap-2 container laptop:mx-auto laptop:mb-10 laptop:mt-10 laptop:gap-10">
